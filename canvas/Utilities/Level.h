...
namespace art {
  ...
  enum class Level {Job=0, InputFile, Run, SubRun, Event, NumNestingLevels,
                    ReadyToAdvance};
  ...
  inline std::ostream& operator<<(std::ostream& os, Level const l)
  {
    switch(l) {
    case Level::Job: os << "Job"; break;
    case Level::InputFile: os << "InputFile"; break;
    case Level::Run: os << "Run"; break;
    case Level::SubRun: os << "SubRun"; break;
    case Level::Event: os << "Event"; break;
    case Level::NumNestingLevels: os << underlying_value(Level::NumNestingLevels); break;
    case Level::ReadyToAdvance: os << "ReadyToAdvance"; break;
    }
    return os;
  }
