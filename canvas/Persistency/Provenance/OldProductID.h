#ifndef canvas_Persistency_Provenance_OldProductID_h
#define canvas_Persistency_Provenance_OldProductID_h

/*----------------------------------------------------------------------

OldProductID: A unique identifier for each EDProduct within a process.
...
namespace art {
  ...
  public:
    ...
    OldProductID(ProcessIndex processIndex, ProductIndex productIndex)
