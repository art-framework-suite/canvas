...
// Note: Cannot be noexcept because of processHistoryID_, allEventsProcessHistories_, and id_.
RunAuxiliary::
~RunAuxiliary()
{
}
...
// Note: Cannot be noexcept because of processHistoryID_, allEventsProcessHistories_, and id_.
RunAuxiliary::
RunAuxiliary(RunAuxiliary const& rhs)
...
RunAuxiliary&
RunAuxiliary::
operator=(RunAuxiliary const& rhs)
{
  if (this != &rhs) {
    processHistoryID_ = rhs.processHistoryID_;
    allEventsProcessHistories_ = rhs.allEventsProcessHistories_;
...
void
RunAuxiliary::
beginTime(Timestamp const& time)
{
  beginTime_ = time;
}
...
bool
RunAuxiliary::
mergeAuxiliary(RunAuxiliary const& newAux)
{
...
void
RunAuxiliary::
mergeNewTimestampsIntoThis_(RunAuxiliary const& newAux)
{
...
void
RunAuxiliary::
mergeNewProcessHistoryIntoThis_(RunAuxiliary const& newAux)
{
  allEventsProcessHistories_.insert(newAux.allEventsProcessHistories_.begin(), newAux.allEventsProcessHistories_.end());
}
