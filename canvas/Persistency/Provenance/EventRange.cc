...
EventRange
EventRange::
forSubRun(SubRunNumber_t const s) noexcept
{
...
EventRange::
EventRange(SubRunNumber_t const s, EventNumber_t const b, EventNumber_t const e)
  : subRun_{s}
  , begin_{b}
  , end_{e}
{
...
EventRange::
EventRange(EventRange const& rhs) noexcept
  : subRun_{rhs.subRun_}
  , begin_{rhs.begin_}
  , end_{rhs.end_}
{
...
EventRange::
EventRange(EventRange&& rhs) noexcept
  : subRun_{rhs.subRun_}
  , begin_{rhs.begin_}
  , end_{rhs.end_}
{
...
EventRange&
EventRange::
operator=(EventRange const& rhs) noexcept
{
  if (this != &rhs) {
    subRun_ = rhs.subRun_;
    begin_ = rhs.begin_;
...
EventRange&
EventRange::
operator=(EventRange&& rhs) noexcept
{
  subRun_ = rhs.subRun_;
  begin_ = rhs.begin_;
  end_ = rhs.end_;
...
bool
EventRange::
contains(SubRunNumber_t const s, EventNumber_t const e) const noexcept
{
