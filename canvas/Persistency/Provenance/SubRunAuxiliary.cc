...
SubRunAuxiliary::
SubRunAuxiliary(SubRunAuxiliary const& rhs)
...
SubRunAuxiliary::
SubRunAuxiliary(SubRunAuxiliary&& rhs)
...
SubRunAuxiliary&
SubRunAuxiliary::
operator=(SubRunAuxiliary const& rhs)
{
  if (this != &rhs) {
    processHistoryID_ = rhs.processHistoryID_;
    rangeSetID_ = rhs.rangeSetID_;
...
bool
SubRunAuxiliary::
mergeAuxiliary(SubRunAuxiliary const& newAux)
{
