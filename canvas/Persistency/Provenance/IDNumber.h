...
struct IDNumber<Level::Event> {
  ...
  static constexpr type invalid() noexcept { return -1u; }
  static constexpr type max_valid() noexcept { return invalid() - 1u; }
  static constexpr type flush_value() noexcept { return max_valid(); }
  static constexpr type max_natural() noexcept { return flush_value() - 1u; }
  static constexpr type first() noexcept { return 1u; }
  static type next(type const n) noexcept { return n + 1u; }
};
...
struct IDNumber<Level::SubRun> {
  ...
  static constexpr type flush_value() noexcept { return max_valid(); }
  static constexpr type max_natural() noexcept { return flush_value() - 1u; }
  static constexpr type first() noexcept { return 0u; }
};
